...
import { DocumentType, Document as DocumentData, DocumentParentType, DocumentTemplate, Property, Tenant, UserProfile, MaintenanceRequest, Inspection } from '../../types';
import Button from '../common/Button';
import DocumentForm from '../forms/DocumentForm';
import DocumentGenerationModal from '../modals/DocumentGenerationModal';
import { PlusCircleIcon, TrashIcon, DocumentTextIcon, PaperClipIcon, LinkIcon, DocumentCheckIcon as HeroDocumentCheckIcon, DocumentDuplicateIcon } from '../icons/HeroIcons';
    ...
    <div className="mt-6 pt-4 border-t">
      <div className="flex justify-between items-center mb-3">
        ...
        <div className="flex gap-2">
            <Button size="sm" variant="outline" onClick={() => setIsGenerationModalOpen(true)} leftIcon={<DocumentDuplicateIcon className="w-4 h-4"/>}>
