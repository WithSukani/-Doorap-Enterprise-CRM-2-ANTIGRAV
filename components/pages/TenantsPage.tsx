...
import { Tenant, Property, Document, CommunicationLog, DocumentTemplate, UserProfile, MeterReading, InventoryItem, EmailIntegrationSettings, Folder } from '../../types';
...
const TenantsPage: React.FC<TenantsPageProps> = ({
    ...
    onSaveMeterReadings, onSaveInventory, emailSettings, folders
}) => {
