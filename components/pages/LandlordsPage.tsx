...
const AddLandlordModal = ({ isOpen, onClose, onSubmit }: any) => {
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                <div className="space-y-4">
                    <Input
                        ...
                        required
                        icon={<UserGroupIcon className="w-4 h-4 text-zinc-400" />}
                    />
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <Input
                            label="Email Address"
                            ...
                            required
                            icon={<EnvelopeIcon className="w-4 h-4 text-zinc-400" />}
                        />
                        <Input
                            label="Phone Number"
                            name="phone"
                            ...
                            icon={<PhoneIcon className="w-4 h-4 text-zinc-400" />}
                        />
                    </div>
                    <Input
                        label="Address"
                        ...
                        icon={<MapPinIcon className="w-4 h-4 text-zinc-400" />}
                    />
                </div>
                <div className="flex justify-end space-x-3 pt-4 border-t border-zinc-100">
                    <Button type="button" variant="outline" onClick={onClose}>Cancel</Button>
...
const LandlordsPage: React.FC<LandlordsPageProps> = ({
    ...
    const handleAddClient = (data: any) => {
        const newLandlord: Landlord = {
            ...
            isArchived: false,
            properties: [] // Initial empty list
        };
        addLandlord(newLandlord);
        setActiveLandlord(newLandlord); // Open the new profile
    }
