...
import { Tenant, Property, Document, CommunicationLog, DocumentTemplate, UserProfile, Folder } from '../../types';
...
const TenantDetailsModal: React.FC<TenantDetailsModalProps> = ({
  ...
  documentTemplates, properties, tenants, userProfile, folders
}) => {
